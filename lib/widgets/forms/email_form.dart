...
class _EmailFormState extends State<EmailForm> {
  ...
  String? _validateEmail(String? value) {
    ...
    if (!emailRegex.hasMatch(value)) return context.t('form_error_email');
    return null;
  }
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              labelText: context.t('form_email_address'),
              labelStyle: TextStyle(
                fontSize: 13,
                color: theme.colorScheme.onSurfaceVariant,
              ),
              hintText: context.t('form_email_hint'),
              prefixIcon: Icon(
          ...
          TextFormField(
            ...
            style: const TextStyle(fontSize: 14),
            decoration: InputDecoration(
              labelText: context.t('form_email_subject'),
              labelStyle: TextStyle(
                fontSize: 13,
                color: theme.colorScheme.onSurfaceVariant,
              ),
          ...
          TextFormField(
            ...
            style: const TextStyle(fontSize: 14),
            decoration: InputDecoration(
              labelText: context.t('form_email_body'),
              labelStyle: TextStyle(
                fontSize: 13,
                color: theme.colorScheme.onSurfaceVariant,
              ),
